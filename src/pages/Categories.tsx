...
export const Categories = () => {
    ...
    return (
        <div className="space-y-10 max-w-6xl mx-auto pb-20 animate-in fade-in duration-700">
                    ...
                    <div className="bg-white dark:bg-[#09090b] border border-slate-200 dark:border-white/10 rounded-[3.5rem] w-full max-w-xl overflow-hidden animate-in zoom-in-95 duration-300 shadow-3xl">
                        ...
                        <form onSubmit={handleUpdate} className="p-12 space-y-10">
                            <div className="group">
                                ...
                                <input
                                    type="text" className="category-input w-full !bg-white dark:!bg-[#0f0f12]"
                            ...
                            <div className="group">
                                ...
                                <select
                                    className="category-input w-full !bg-white dark:!bg-[#0f0f12] appearance-none"
            ...
            <style>{`
                .category-input { @apply bg-white dark:bg-[#0f0f12] border border-slate-200 dark:border-white/5 rounded-2xl px-6 py-5 text-slate-900 dark:text-white outline-none focus:border-cyan-500/50 shadow-inner placeholder:text-slate-400 dark:placeholder:text-slate-800 transition-all font-bold text-sm; }
                .custom-scrollbar::-webkit-scrollbar { width: 4px; }
                .custom-scrollbar::-webkit-scrollbar-thumb { background: #cbd5e1; border-radius: 10px; }
                .dark .custom-scrollbar::-webkit-scrollbar-thumb { background: #1e1e2d; }
            `}</style>
        </div>
    );
};
