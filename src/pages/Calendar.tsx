        ...
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
                    <div className="premium-card !bg-white dark:!bg-black shadow-[0_0_50px_rgba(34,211,238,0.1)] w-full max-w-md animate-in zoom-in-95 duration-200 border-white/10">
                        <div className="flex justify-between items-center p-6 border-b border-slate-100 dark:border-white/5">
                            <h3 className="text-lg font-black text-slate-800 dark:text-white italic uppercase tracking-tighter">
                                {editingEvent ? (
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            <div>
                                <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2 italic">Título do Compromisso</label>
                                <input
                                    type="text"
                                    required
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2 italic">Início</label>
                                    <input
                                        type="datetime-local"
                                        required
                                        className="premium-input !pl-4 uppercase"
                                ...
                                <div>
                                    <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2 italic">Término</label>
                                    <input
                                        type="datetime-local"
                                        required
                                        className="premium-input !pl-4 uppercase"
                            ...
                            <div>
                                <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2 italic">Categoria</label>
                            ...
                            <div>
                                <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2 italic">Observações</label>
                                <textarea
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2 italic">Corretor Responsável</label>
                                    <select
                                ...
                                <div>
                                    <label className="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2 italic">Cliente Vinculado</label>
                                    <select
                                        className="premium-input !pl-4"
