...
export const CashFlow = () => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 pb-20">
      ...
      {/* CRUD Modal */}
      {showModal && (
        <div className="fixed inset-0 bg-background/90 z-50 flex items-center justify-center p-4 backdrop-blur-2xl">
          <div className="premium-card !bg-background border border-white/10 w-full max-w-lg p-8 shadow-3xl animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSave} className="space-y-6">
              ...
              <div>
                ...
                <input
                  required
                  className="bg-[#050505] border border-white/10 rounded-2xl px-5 py-3 w-full text-foreground outline-none focus:border-primary/50 transition-all font-medium text-xs placeholder:text-muted-foreground/50"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="bg-[#050505] border border-white/10 rounded-2xl px-5 py-3 w-full text-foreground outline-none focus:border-primary/50 transition-all font-mono text-sm"
                ...
                <div>
                  ...
                  <select
                    required
                    className="bg-[#050505] border border-white/10 rounded-2xl px-5 py-3 w-full text-foreground outline-none focus:border-primary/50 transition-all text-xs appearance-none"
              ...
              {formData.category === 'Comissão' && formData.type === 'expense' && (
                <div className="bg-primary/5 p-4 rounded-lg border border-primary/20">
                  ...
                  <select
                    className="bg-[#050505] border border-white/10 rounded-2xl px-5 py-3 w-full text-foreground outline-none focus:border-primary/50 transition-all text-xs appearance-none mb-1"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="date" required
                    className="bg-[#050505] border border-white/10 rounded-2xl px-5 py-3 w-full text-foreground outline-none focus:border-primary/50 transition-all text-xs"
                    value={formData.date}
              ...
              <div className="flex items-center gap-2 pt-2">
                <input
                  ...
                  className="w-5 h-5 accent-primary bg-[#050505] border-white/10 rounded"
                />
