...
import { PrintableAgentForm } from '../components/agents/PrintableAgentForm';
...
export const Agents = () => {
  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row gap-6 h-full lg:h-[calc(100vh-8rem)] animate-in fade-in duration-700 print:hidden">
